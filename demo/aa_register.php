    ...
    <div class="card-body" >
      ...
      <form action="../../index3.html" method="post">
         <div class="input-group mb-3">
          <input id="as_name" type="text" class="form-control k-rtl" placeholder="الاسم ">
...
<div class="input-group mb-3">
          <input id="as_email" type="email" class="form-control k-rtl" placeholder="البريد الإلكتروني ">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div    class="input-group mb-3">
          ...
          <div    class="input-group mb-3">
          <input id="as_passb"  type="password" class="form-control k-rtl" placeholder="تاكيد كلمة المرور "  required  >
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
...
دخول
              ...
              <p class="mb-1">
        <a href="restpass.php"> تاكيد الحساب</a>
      </p>
      <p class="mb-0">
